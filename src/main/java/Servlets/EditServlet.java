...
public class EditServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
     Long id=Long.parseLong(request.getParameter("id"));
        ...
        request.setAttribute("newsCategories",DBManager.getCategories());
        ...
        request.setAttribute("Sign in", Translations.translations.get(0).get(4));
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
     Long id=Long.parseLong(request.getParameter("id"));
     DBManager.getCategory(Long.valueOf(request.getParameter("category_id")));
     DBManager.getLanguage(Long.valueOf(request.getParameter("language_id")));
     DBManager.saveNews(new News(id,new Date(),DBManager.getCategory(Long.valueOf(request.getParameter("category_id"))),DBManager.getLanguage(Long.valueOf(request.getParameter("language_id"))),request.getParameter("title"),request.getParameter("content")));
