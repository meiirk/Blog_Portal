...
public class ProfileServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
     String profile_lang=request.getParameter("profile_lang");
     request.setAttribute("profile_lang",profile_lang);
...
if(profile_lang!=null){
          ...
          request.setAttribute("Comments_",Comments_);
          request.setAttribute("Registration_",Registration_);
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        Users current_user= DBManager.getUser(id);

        current_user.setEmail(current_user.getEmail());
        current_user.setPassword(request.getParameter("password"));
        current_user.setFull_name(request.getParameter("fullname"));
        current_user.setRole_id(current_user.getRole_id());

        DBManager.saveUser(current_user);
